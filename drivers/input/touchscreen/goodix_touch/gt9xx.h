...
#define GTP_INVERT_X          0    // final_x = x_max - x
#define GTP_INVERT_Y          0    // final_y = y_max - y
...
#define GTP_WITH_HOVER        0    // pen support hover or not 1:enable 0 disable
...
#define GTP_RST_PORT    420
#define GTP_INT_PORT    415
...
// Dimensions are for a landscape configuration
#if GTP_CUSTOM_CFG
  #define GTP_MAX_HEIGHT   599
  #define GTP_MAX_WIDTH    1023
...
#define GTP_WARN(fmt,arg...)           printk("<<-GTP-WARNING->> "fmt"\n",##arg)
