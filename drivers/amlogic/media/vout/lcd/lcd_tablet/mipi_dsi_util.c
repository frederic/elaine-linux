...
void mipi_dsi_switch_op_mode_display(struct lcd_config_s *pconf)
{
	unsigned int op_mode_init, op_mode_disp;

	op_mode_init = pconf->lcd_control.mipi_config->operation_mode_init;
	op_mode_disp = pconf->lcd_control.mipi_config->operation_mode_display;
	...
	pconf->lcd_control.mipi_config->mode_update_flag = 0;
}
