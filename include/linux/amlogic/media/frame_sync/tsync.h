...
extern void tsync_avevent2(enum avevent_e event, unsigned long param1,
...
extern int tsync_get_external_rate(void);
...
extern bool tsync_is_video_started(void);
