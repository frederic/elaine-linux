...
static struct hdmi_format_para fmt_para_600x1280p60_15x32 = {
	.vic = HDMIV_600x1024p60hz,
	.name = "600x1024p60hz",
	.sname = "600x1024p60hz",
	.pixel_repetition_factor = 0,
	.progress_mode = 1,
...
static struct hdmi_format_para fmt_para_1024x600p60_17x10 = {
...
static struct hdmi_format_para *all_fmt_paras[] = {
	...
	&fmt_para_600x1280p60_15x32,
	&fmt_para_1024x600p60_17x10,
...
struct hdmi_format_para *hdmi_get_fmt_name(char const *name, char const *attr)
{
	...
	/* For VESA modes, only supports RGB & 24BITS */
