...
#define AIU_AIFIFO_CTRL		(0x1580-0x80)
#define AIU_AIFIFO_STATUS	(0x1581-0x80)
#define AIU_AIFIFO_GBIT		(0x1582-0x80)
#define AIU_AIFIFO_CLB		(0x1583-0x80)
#define AIU_MEM_AIFIFO_START_PTR	(0x1584-0x80)
#define AIU_MEM_AIFIFO_CURR_PTR		(0x1585-0x80)
#define AIU_MEM_AIFIFO_END_PTR		(0x1586-0x80)
#define AIU_MEM_AIFIFO_BYTES_AVAIL	(0x1587-0x80)
#define AIU_MEM_AIFIFO_CONTROL		(0x1588-0x80)
#define AIU_MEM_AIFIFO_MAN_WP		(0x1589-0x80)
#define AIU_MEM_AIFIFO_MAN_RP		(0x158a-0x80)
#define AIU_MEM_AIFIFO_LEVEL		(0x158b-0x80)
#define AIU_MEM_AIFIFO_BUF_CNTL		(0x158c-0x80)
#define AIU_MEM_AIFIFO_BUF_WRAP_COUNT	(0x158d-0x80)
#define AIU_MEM_AIFIFO2_BUF_WRAP_COUNT	(0x158e-0x80)
#define AIU_MEM_AIFIFO_MEM_CTL		(0x158f-0x80)
#define AIFIFO_TIME_STAMP_CNTL		(0x1590-0x80)
#define AIFIFO_TIME_STAMP_SYNC_0	(0x1591-0x80)
#define AIFIFO_TIME_STAMP_SYNC_1	(0x1592-0x80)
#define AIFIFO_TIME_STAMP_0			(0x1593-0x80)
#define AIFIFO_TIME_STAMP_1			(0x1594-0x80)
#define AIFIFO_TIME_STAMP_2			(0x1595-0x80)
#define AIFIFO_TIME_STAMP_3			(0x1596-0x80)
#define AIFIFO_TIME_STAMP_LENGTH	(0x1597-0x80)
