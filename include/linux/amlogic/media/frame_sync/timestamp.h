...
extern u32 timestamp_vpts_ts_get(struct timespec64 *ts);

extern void timestamp_vpts_set(u32 pts);

extern void timestamp_vpts_reset(u32 pts);
...
extern void timestamp_pcrscr_set_ts(unsigned long tv_sec,
			unsigned long tv_nsec, u32 pts);

extern void timestamp_pcrscr_inc(s32 val);

extern void timestamp_pcrscr_inc_scale(s32 inc, u32 base);

extern void timestamp_pcrscr_pause_pts(u32 pts);
...
extern bool timestamp_vpts_get_started(void);

extern void timestamp_vpts_set_started(bool start);

extern void timestamp_reftime_pause(bool pause);
