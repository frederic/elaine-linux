...
#ifdef CONFIG_CFG80211_FAKE_REGDB
	// Only need to pass along the country code, give generic regulatory rules
	struct ieee80211_regdomain *regdom =
		(struct ieee80211_regdomain *)(reg_copy_regd(&world_regdom));
	regdom->alpha2[0] = alpha2[0];
	regdom->alpha2[1] = alpha2[1];
...
{
#ifndef CONFIG_CFG80211_FAKE_REGDB
